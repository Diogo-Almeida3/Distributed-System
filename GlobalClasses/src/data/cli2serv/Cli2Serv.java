...
public abstract class Cli2Serv implements Serializable {
    ...
    public enum RequestType{
        ...
        CREATE_GROUP, JOIN_GROUP, LIST_GROUPS,LEAVE_GROUP,
        LIST_REQUESTS,SEND_MESSAGE,DELETE_MESSAGE,EXIT,TCP_PORT,ADMIN_GROUP,GET_MESSAGES,REFUSE_CONTACT,SEND_FILE;
    }
}
